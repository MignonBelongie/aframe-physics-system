...
```html
<script src="https://cdn.jsdelivr.net/gh/n5ro/aframe-physics-system@v4.0.2/dist/aframe-physics-system.min.js"></script>
```

CDN builds for aframe-physics-system@v4.0.2:

- [aframe-physics-system.js](https://cdn.jsdelivr.net/gh/n5ro/aframe-physics-system@v4.0.2/dist/aframe-physics-system.js) *(development)*
- [aframe-physics-system.min.js](https://cdn.jsdelivr.net/gh/n5ro/aframe-physics-system@v4.0.2/dist/aframe-physics-system.min.js) *(production)*
